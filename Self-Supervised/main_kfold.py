...
from lightning_data_terminal import KFoldMultiCamDailyCowsDataModule
...
if __name__ == '__main__':
    ...
    #     print(data_batch[2])
    cli = LightningCLI(MultiCamModel, KFoldMultiCamDailyCowsDataModule, parser_kwargs={"parser_mode": "omegaconf"})
