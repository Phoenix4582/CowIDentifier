...
def plotEmbeddings(args):
	...
	scatter(reduction, embeddings['labels'], args.file_name)
...
if __name__ == '__main__':
	...
	parser.add_argument('--file_name', type=str, default='test_embeddings',
						help="PDF file name containing visualised results.")
