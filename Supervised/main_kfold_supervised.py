...
from lightning_supervised_model import MultiCamSupervisedModel

# Import Datasets
# from lightning_data_terminal import DataModuleTerminal
# from lightning_data_terminal import LightningCowDataModule
from lightning_data_terminal import KFoldsMultiCamCowsDataModule

if __name__ == '__main__':
    # cli = LightningCLI(MultiCamModel, MultiCamCowsDataModule, parser_kwargs={"parser_mode": "omegaconf"})
    cli = LightningCLI(MultiCamSupervisedModel, KFoldsMultiCamCowsDataModule, parser_kwargs={"parser_mode": "omegaconf"})
